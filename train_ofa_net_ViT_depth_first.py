...
if args.task == "depth":
    ...
    args.depth_list = "3, 4, 6, 8, 10, 15, 20"
elif args.task == "heads":
    args.path = "exp/depth2depth_heads/phase%d" % args.phase
    args.dynamic_batch_size = 2
    if args.phase == 1:
        args.n_epochs = 75
        args.base_lr = 1e-4
        ...
        args.warmup_epochs = 30
        args.warmup_lr = 0
        args.heads_list = "4, 8, 12"
        args.width_mult_list = "8"
        args.depth_list = "3, 4, 6, 8, 10, 15, 20"
elif args.task == "width_mult":
    args.path = "exp/heads_depth2heads_depth_width/phase%d" % args.phase
...
if __name__ == "__main__":
    ...
    args.ofa_checkpoint_path = None #"./exp/normal2depth/checkpoint/model_best.pth.tar"
